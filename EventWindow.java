...
/**	
 *	The class EventWindow creates a JFrame and a JPanel for  
 *	some basic drawing methods. In addition the window listens to 
 *	mouse-clicks and some key-presses and can return the 
 *	coordinates of the click and type of key.
 *
 * @author 	Stefan Sollander
 * @version 1.5
 *
...
public final class EventWindow extends JFrame{
	...
	/**
	 * 	The class constructor. Creates a EventWindow with 
	 *	the specified width, height and name.
	 *
	...
	/**
	 * Depending on which key were last pressed the method 
	 * returns a different integer.
	 * @return	UP returns 1, DOWN returns 2, LEFT returns 3, 
	 * RIGHT returns 4 and SPACE returns 5.
	 * W returns 6, S returns 7, A returns 8, D returns 9. 
	 * No key pressed returns -1.
	 */
	public int getKey() {
		switch ( this.key ) {
			case KeyEvent.VK_UP:
	 ...
	 *	@param millisec The specified time in milliseconds the 
	 *EventWindow pauses.
	 */	
